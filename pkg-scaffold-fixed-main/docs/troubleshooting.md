...
This guide covers common issues you might encounter while using pkg-scaffold v4.0 and provides solutions to resolve them.
...
- **Solution**:
  - Use `// pkg-scaffold-ignore` comments above the flagged code.
...
### "Command not found: pkg-scaffold"
- **Solution**: Ensure you have installed the package locally and are using `npx pkg-scaffold` or have added it to your `PATH`.
...
- **Solution**:
  ...
  - Try clearing the cache: `rm -rf .pkg-scaffold/cache`.
...
1. Check the [GitHub Issues](https://github.com/DreamLongYT/pkg-scaffold/issues).
