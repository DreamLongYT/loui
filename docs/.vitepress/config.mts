...
export default defineConfig({
  ...
  head: [
    ...
    ['meta', { property: 'og:url', content: 'https://dreamlongyt.github.io/entkapp/' }],
    ['meta', { name: 'twitter:card', content: 'summary_large_image' }],
    ['meta', { name: 'twitter:title', content: 'entkapp - Enterprise Codebase Janitor' }],
  ...
  themeConfig: {
    ...
    socialLinks: [
      { icon: 'github', link: 'https://github.com/DreamLongYT/entkapp' },
      { icon: 'npm', link: 'https://www.npmjs.com/package/entkapp'}
    ],
    footer: {
