...
Asset Tracking in pkg-scaffold v4.0 allows you to manage static assets like images, videos, and fonts with the same precision as your source code. The engine analyzes how assets are referenced and identifies orphans that are no longer used.
...
Configure asset tracking in `pkg-scaffold/config.json`:
